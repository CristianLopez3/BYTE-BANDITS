<body>
    ...
    <div class="container-login container-fluid d-flex flex-column justify-content-center align-items-center">
        <form class="p-5" id="registerForm" action="#" method="post">
            ...
            <div class="form-floating">
                <input type="hidden" name="role" value="ROLE_STUDENT" class="form-role" id="role" placeholder="name@example.com" readonly>
                <label for="floatingInput">Rol del Usuario</label>
            </div>
            <div class="form-floating">
                <input type="text" name="city" class="form-control" id="city" placeholder="name@example.com">
                <label for="floatingInput">Ciudad de Residencia</label>
            </div>
            <div class="form-floating">
                <input type="date" name="date" class="form-control" id="date" placeholder="name@example.com">
